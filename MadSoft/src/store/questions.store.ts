...
import { QuestionListItemSchemas } from '../schemas/questions.schemas'
...
export const QuestionStore = create<QuestionnaireStoreProps>()(
    persist(
        (set, get) => ({
            ...
            addNewQuestion: (question) => {
                ...
                try {
                    const result = QuestionListItemSchemas.safeParse(question)
