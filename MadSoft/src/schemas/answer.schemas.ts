...
export const AnswerOptionBaseToRenderSchemas = AnswerOptionBaseSchemas.merge(z.object({ isSuccess: z.boolean() }))
export type AnswerOptionBaseToRenderType = z.infer<typeof AnswerOptionBaseToRenderSchemas>
